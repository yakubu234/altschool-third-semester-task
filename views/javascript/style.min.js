...
function botMessage(msg) {
    ...
    try {
        ...
        for (let i = 0; i < jsonObject.length; i++) {
            const menu = jsonObject[i];
            if (!menu.menu) {
                data += " " + menu.comments + "  <br>"
                continue;
            }

            data += menu.number ? "<br> select <b>" + menu.number + "</b> for <br> " : ""
            data += menu.menu ? " <b> Menu: </b> " + menu.menu + " <br> @  &#x20A6; " : ""
            data += menu.price ? " " + menu.price + " <br> " : ""
            data += menu.time ? " <b>Date</b>: " + menu.time + " <br> " : ""
            data += "<br>"
        }
