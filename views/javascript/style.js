  ...
  $(document).on("submit", "#messenger", function (e) {
    ...
    function userMsg(msg) {
      $(".Messages_list").append(
        '<div class="msg user" style="margin-bottom:30px;"><span class="avtr"><figure style="background-image: url(https://mrseankumar25.github.io/Sandeep-Kumar-Frontend-Developer-UI-Specialist/images/avatar.png)"></figure></span><span class="responsText">' +
          mainval +
          "<span class='chat-timestamp'><b>user</b> - Today 05:49</span></span></div>"
      );
    }
    ...
    function appendMsg(msg) {
      $(".Messages_list").append(
        '<div class="msg bot-msg"><span class="avtr robot"><figure style="background-image: url(../img/robot.svg)"></figure></span><span class="responsText">' +
          msg +
          "<span class='chat-timestamp'><b>Bot</b> - Today 05:49</span></span></div>"
      );
      $("[name='msg']").val("");
    }
